...
Prefer semantic HTML before ARIA for web and Shopify Liquid themes, React Native primitives and accessibility props for React Native, and native SwiftUI/UIKit controls and platform accessibility APIs for iOS. Preserve existing styling/API/navigation contracts unless approved, and never claim full compliance. Report verified findings, changed files, checks run, and residual risk.
